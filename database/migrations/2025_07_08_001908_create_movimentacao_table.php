...
class CreateMovimentacaoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('movimentacao', function (Blueprint $table) {
            ...
            $table->foreignId('unidade_origem_id')->nullable()->constrained('setores')->onDelete('restrict');
            $table->foreignId('unidade_destino_id')->nullable()->constrained('setores')->onDelete('restrict');
